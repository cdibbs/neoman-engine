...
export interface IHandlerInterfaceConfig extends IBaseInterfaceConfig<"handler">, IHandlerReference {
}
export interface IPluginInterfaceConfig extends IBaseInterfaceConfig<"plugin">, IPluginReference {
}
/**
 ...
 */
export declare type InputInterfaceConfig = IPromptInterfaceConfig | IArgvInterfaceConfig | IBrowserInterfaceConfig | IHandlerInterfaceConfig | IPluginInterfaceConfig;
