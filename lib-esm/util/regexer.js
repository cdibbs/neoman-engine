...
export class Regexer {
    ...
    transform(source, pattern, replace, mods) {
    ...
    replacer(replacement, mods, match, /* corresponds to "$&" */ ...pn /* correspond to $1, $2... */) {
    ...
    getModResultsDict(mods, match, /* corresponds to "$&" */ pn, /* correspond to $1, $2... */ offset, whole) {
        const results = {};
