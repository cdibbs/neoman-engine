...
export interface ITransformPlugin extends INeedy {
     ...
     */
    transform(path: string, original: string, subject: string | ISubjectDefinition, transformOrTransformer: string | ((subj: string) => string), pluginOptions: any): Promise<string>;
}
