...
var base_tree_transformer_1 = require("./base-tree-transformer");
var template_content_file_1 = require("../models/template-content-file");
...
var TreeTransformer = /** @class */ (function (_super) {
    __extends(TreeTransformer, _super);
    function TreeTransformer(msg, pathTransformManager, transformManager, mapper) {
    ...
    TreeTransformer.prototype.transform = function (pathTransforms, contentTransforms, verbosity, discovery) {
        return __awaiter(this, void 0, void 0, function () {
            var transformed, _a, t, ex_1, msg;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        this.msg.i18n({ absPath: discovery.file.absolutePath }).debug("Include: {absPath}");
                        transformed = this.mapper.map(discovery.file, template_content_file_1.TemplateContentFile, { exceptions: { "getContents": models_1.MapOption.Ignore } });
                        transformed.hasContents = true;
                        transformed.getContents = util_1.curry.twoOf2(this.contentBuilder, this, contentTransforms, discovery.file);
                        this.msg.i18n({ absPath: discovery.file.absolutePath })
                            .info("Transforming path '{absPath}'...");
                        _a = transformed;
                        return [4 /*yield*/, this.pathTransformManager.applyTransforms(discovery.file.relativePath, pathTransforms)];
                    case 1:
                        _a.relativePath = _b.sent();
                        t = new transform_1.Transform();
                        t.file = transformed;
                        return [2 /*return*/, t];
                    case 2:
                        ex_1 = _b.sent();
                        ...
                        throw new NestedError(msg, ex_1);
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    TreeTransformer.prototype.contentBuilder = function (transforms, tmplFile) {
        return __awaiter(this, void 0, void 0, function () {
            var content;
    ...
    TreeTransformer = __decorate([
        ...
        __metadata("design:paramtypes", [Object, Object, Object, mapper_1.Mapper])
    ], TreeTransformer);
    return TreeTransformer;
}(base_tree_transformer_1.BaseTreeTransformer));
